...
import LOGO from "../static/image/logo/jjy_logo.png"
        ...
        <nav className="py-3.5 bg-white border-gray-200 px-4 lg:px-6 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-lg">
            <a href="/" className="flex items-center">
              <img src={LOGO} className="mr-3 h-6 sm:h-9" alt="로고 설명" />
              <span className="self-center text-xl font-semibold whitespace-nowrap tracking-wide dark:text-white">JJY Vault</span>
            </a>
