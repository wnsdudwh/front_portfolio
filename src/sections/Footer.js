    ...
    return (
        ...
        <div class="max-w-screen-lg mx-auto h-[100px] md:h-[110px] flex flex-col justify-center items-start">
          <div class="font-normal text-gray-700 text-base flex gap-0.5 flex-col">
            <div class="inline-block px-1"><a class="hover:underline" href="mailto:dhdhwnsdud1@naver.com" target="_blank" aria-label="이메일 주소 : dhdhwnsdud1@naver.com">dhdhwnsdud1@naver.com</a></div>
            <div class="inline-block px-1"><a class="hover:underline" href="https://github.com/wnsdudwh" target="_blank" aria-label="깃허브 주소 : https://github.com/wnsdudwh">https://github.com/wnsdudwh</a></div>
          </div>
